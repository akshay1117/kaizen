...
import 'package:kaizen/features/habits/presentation/screens/habit_detail_screen.dart';
                ...
                children: [
                  ...
                  Consumer(
                    builder: (context, ref, child) {
                      final streakAsync = ref.watch(globalHabitStreakProvider);
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: Container(
                decoration: BoxDecoration(
                  color: AppColors.surfaceElevatedLow, // Dark theme grouped background
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isCompleted ? habitColor : AppColors.borderSpecular,
                    width: 2,
                  ),
                ),
                child: isCompleted
