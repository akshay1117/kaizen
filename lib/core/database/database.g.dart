...
class $WaterEntriesTable extends WaterEntries
  ...
  late final GeneratedColumn<DateTime> createdAt = GeneratedColumn<DateTime>(
      ...
      clientDefault: () => DateTime.now());
  @override
  List<GeneratedColumn> get $columns => [id, amount, date, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class WaterEntry extends DataClass implements Insertable<WaterEntry> {
  ...
  WaterEntry copyWith(
          {String? id, double? amount, DateTime? date, DateTime? createdAt}) =>
      WaterEntry(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, amount, date, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WaterEntry &&
...
class $SleepRecordsTable extends SleepRecords
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, bedtime, wakeupTime, sleepScore, date, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  SleepRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SleepRecord(
      ...
      wakeupTime: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}wakeup_time'])!,
...
class SleepRecord extends DataClass implements Insertable<SleepRecord> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['wakeup_time'] = Variable<DateTime>(wakeupTime);
  ...
  @override
  int get hashCode =>
      Object.hash(id, bedtime, wakeupTime, sleepScore, date, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class SleepRecordsCompanion extends UpdateCompanion<SleepRecord> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (wakeupTime.present) {
      map['wakeup_time'] = Variable<DateTime>(wakeupTime.value);
    }
...
class $CalorieEntriesTable extends CalorieEntries
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, mealType, name, calories, date, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<CalorieEntry> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class CalorieEntry extends DataClass implements Insertable<CalorieEntry> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, mealType, name, calories, date, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$SleepRecordsTableFilterComposer
  ...
  ColumnFilters<DateTime> get wakeupTime => $composableBuilder(
...
class $$SleepRecordsTableOrderingComposer
  ...
  ColumnOrderings<DateTime> get wakeupTime => $composableBuilder(
...
class $$SleepRecordsTableAnnotationComposer
  ...
  GeneratedColumn<DateTime> get wakeupTime => $composableBuilder(
...
typedef $$SleepRecordsTableProcessedTableManager = ProcessedTableManager<
    ...
    SleepRecord,
    PrefetchHooks Function()>;
typedef $$CalorieEntriesTableCreateCompanionBuilder = CalorieEntriesCompanion
    Function({
  Value<String> id,
  required String mealType,
  Value<String?> name,
...
typedef $$CalorieEntriesTableUpdateCompanionBuilder = CalorieEntriesCompanion
    Function({
  Value<String> id,
  Value<String> mealType,
  Value<String?> name,
...
class $$CalorieEntriesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $CalorieEntriesTable,
    CalorieEntry,
    $$CalorieEntriesTableFilterComposer,
  ...
  $$CalorieEntriesTableTableManager(
      _$AppDatabase db, $CalorieEntriesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$CalorieEntriesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CalorieEntriesTable,
    CalorieEntry,
    $$CalorieEntriesTableFilterComposer,
